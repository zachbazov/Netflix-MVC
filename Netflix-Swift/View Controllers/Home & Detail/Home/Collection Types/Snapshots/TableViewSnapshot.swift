...
@objc protocol TableViewSnapshotDelegate: AnyObject {
    ...
    @objc optional func tableView(_ tableView: UITableView, willConfigure cell: UITableViewCell, at indexPath: IndexPath)
...
final class TableViewSnapshot: NSObject {
    ...
    init(_ state: TableViewSnapshot.State, _ homeViewController: HomeViewController) {
...
//        delegate.tableViewWillBeginLoading?(self.tableView)
    ...
    func tableViewWillBeginLoading(_ tableView: UITableView) {
        ...
        guard requiresInitialLoading else { return }
...
extension TableViewSnapshot: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didEndDisplaying cell: UITableViewCell, forRowAt indexPath: IndexPath) {
        guard let indices: SectionIndices = .init(rawValue: indexPath.section) else { return }
        switch indices {
        case .display: break
    ...
    func tableView(_ tableView: UITableView, prefetchRowsAt indexPaths: [IndexPath]) {
        for indexPath in indexPaths {
            ...
            default:
                ...
                standardCell = tableView.dequeueCell(for: StandardTableViewCell.self, as: StandardTableViewCell.Identifier(rawValue: indices.rawValue), at: indexPath)! as? StandardTableViewCell
            }
        }
    }
}
...
extension TableViewSnapshot {
    ...
    func scrollViewDidScroll(_ scrollView: UIScrollView) {
        ...
        UIView.animate(withDuration: 0.33) {
            ...
            homeViewController.navigationView.layoutIfNeeded()
            homeViewController.statusBarBackgroundView.layoutIfNeeded()
        }
    }
}
