...
extension NavigationItem: NavigationItemDelegate {
    ...
    func navigationItemDidChangeSizeForTitle(_ navigationItem: NavigationItem) {
        guard let state: NavigationView.State = .init(rawValue: navigationItem.tag) else { return }
        switch state {
    ...
    func navigationItemDidConfigure(_ navigationItem: NavigationItem) {
        ...
        let image = UIImage(systemName: navigationItem.systemImage)!
...
final class NavigationItemView: NavigationItem, Nibable {
    ...
    override var title: String! {
        get {
            guard let state: NavigationView.State = .init(rawValue: tag) else { return nil }
            switch state {
            case .home: return ""
