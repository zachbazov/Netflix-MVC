...
@objc protocol NavigationViewDelegate: AnyObject {
    ...
    @objc func navigationView(_ navigationView: NavigationView,
                              didSelect item: Any)
    
    func navigationView(_ navigationView: NavigationView,
                        didChange state: NavigationView.State)
...
extension NavigationView: NavigationViewDelegate {
    ...
    func navigationViewWillPerformInteractions(_ navigationView: NavigationView) {
        ...
        case .home:
            if !hasInteracted
                ...
                guard let maskViewDelegate = maskView.delegate else {
                    return
                }
    ...
    func navigationViewWillDisplayOverlay(_ navigationView: NavigationView) {
        ...
        case .tvShows,
                .movies:
            guard let homeOverlayViewController = homeViewController.homeOverlayViewController else {
                return
            }
